...
When /^I execute the template script$/ do
  ...
  set_environment_variable('GTD_LOGIN','testuser')
  set_environment_variable('GTD_PASSWORD', 'secret')
  set_environment_variable('GTD_TODOS_URL', "http://localhost:#{port}/todos.xml")
  set_environment_variable('GTD_PROJECTS_URL', "http://localhost:#{port}/projects.xml")
  set_environment_variable('GTD_CONTEXT_URL_PREFIX', "http://localhost:#{port}/contexts/")
  set_environment_variable("GTD_CONTEXT_URL","http://localhost:#{port}/contexts.xml")
